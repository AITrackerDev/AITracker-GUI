...
class AITrackerModel():
    def __init__(self):
        ...
        self._predictor = dlib.shape_predictor(os.path.join('AITracker', 'assets', 'shape_predictor_68_face_landmarks.dat'))
        self._image_size = (190, 80)
            
        # load the model into the program
        self._model = tf.keras.models.load_model(os.path.join('AITracker', 'image_classifier.model'))
