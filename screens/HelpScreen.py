...
class HelpScreen(ctk.CTkFrame):
    ...
    def __init__(self, root, screen_changer):
        ...
        _about_label_text = ctk.CTkTextbox(_about_frame, width=_scroll_frame_wid, height=_scroll_frame_hei, font=ctk.CTkFont(size=15), wrap=ctk.WORD, state=ctk.DISABLED)
        ...
        _launch_label_text = ctk.CTkTextbox(_launch_frame, width=_scroll_frame_wid, height=_scroll_frame_hei, font=ctk.CTkFont(size=15), wrap=ctk.WORD, state=ctk.DISABLED)
        ...
        _settings_label_text = ctk.CTkTextbox(_settings_frame, width=_scroll_frame_wid, height=_scroll_frame_hei, font=ctk.CTkFont(size=15), wrap=ctk.WORD, state=ctk.DISABLED)
